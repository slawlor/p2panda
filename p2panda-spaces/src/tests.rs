    ...
    for (idx, message) in alice_messages.iter().enumerate() {
        ...
        match idx {
            ...
            0 => {
                ...
                std::assert_matches!(bob_events[0].clone(), Event::Groups(GroupEvent::Created { context: GroupsContext{ author, .. }, .. }) if author == alice_id);
                std::assert_matches!(bob_events[0].clone(), Event::Groups(GroupEvent::Created { context: GroupsContext{ members, .. }, .. }) if members.len() == 2);
            }
            ...
            1 => {
                ...
                std::assert_matches!(bob_events[0].clone(), Event::Groups(GroupEvent::Created { context: GroupsContext{ author, .. }, .. }) if author == alice_id);
                std::assert_matches!(bob_events[0].clone(), Event::Groups(GroupEvent::Created { context: GroupsContext{ members, .. }, .. }) if members.len() == 3);
            }
            ...
            4 => {
                ...
                std::assert_matches!(bob_events[0].clone(), Event::Groups(GroupEvent::Added { context: GroupsContext{ author, .. }, .. }) if author == alice_id);
                std::assert_matches!(bob_events[0].clone(), Event::Groups(GroupEvent::Added { context: GroupsContext{ members, .. }, .. }) if members.len() == 4);
            }
            5 => {
                assert_eq!(bob_events.len(), 1);
            ...
            6 => {
                ...
                std::assert_matches!(bob_events[0].clone(), Event::Groups(GroupEvent::Removed { context: GroupsContext{ author, .. }, .. }) if author == alice_id);
            }
            7 => {
                assert_eq!(bob_events.len(), 1);
